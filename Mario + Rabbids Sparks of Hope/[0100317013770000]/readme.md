Although the TID is 0100317013770000 (US version) **these mods work for all regions and updates available** without having to make a specific mod for each region or having to update the mod. 
